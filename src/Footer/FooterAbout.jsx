    ...
    return (
        <div className=''>
            <div className='flex flex-col md:flex-row px-4 md:px-24 pt-5 justify-between items-center'>
                <img src={Logo} className="w-24 mb-4 md:mb-0" />
                <a href="https://api.leadconnectorhq.com/widget/service-menu/65e358086ba2ab3555cad7f2" className='border-2 border-[#106D8F] text-[#106D8F] hover:bg-[#1F51FF] hover:text-white p-4 px-10 rounded-xl bg-transparent hover:shadow-md hover:shadow-[#1F51FF]'>Book Now</a>
            </div>
